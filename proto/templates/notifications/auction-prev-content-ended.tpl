<a href="../pages/auction.php?auction_id={$buySel.auction_id}"><div style="background-image:url('../images/item-prev.jpg');" class="prev"> </div></a>
<div class="details">         
    <a href="../pages/auction.php?auction_id={$buySel.auction_id}">
    <div class="costs">
        <div class="container">
