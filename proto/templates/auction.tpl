...
<div class="container-fluid page-wrapper">
    ...
    <div id="auction-carousel" class="carousel slide base-container upper" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            {foreach from=$photos item=photo key=i}
                {if $i eq 0}
                    <div class="item active" style="background-image:url('../images/auction/{$auction.auction_id}/{$photo}');"> </div>
                {else}
                    <div class="item" style="background-image:url('../images/auction/{$auction.auction_id}/{$photo}');"> </div>
                {/if}
            {/foreach}
        </div>
